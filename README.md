...
El nombre viene de la sugerencia automática de GitHub en inglés `friendly-spoon`.
...
- La información es poder. Si queremos un poder realmente democrático y distribuido, es indispensable que todas las personas tengan acceso a toda la información.
- Es decir, qué ha ocurrido, dónde y cuándo.
- Solo fiscalizando eso de una manera humana se puede realmente lograr un mundo más justo
- Comprensión, compasión, paciencia, tolerancia al error, amor, sacrificio
- Responsabilidad, transparencia, claridad
- Lugar a la pereza, el esparcimiento, el juego, el humor
...
20250903, en la playa, leyendo Anarquismo y Socialismo de Bertrand Russell

- La competencia entre seres humanos, ¿dónde se origina? ¿Tiene sentido cuando se descarta la violencia de unos contra otros?
- Ese espíritu de lucha es el que ha llevado a la humanidad a mejorar sus condiciones materiales de vida. Ese es uno de los objetivos de la humanidad, indudablemente.
- La información es poder. Grandes grupos de personas aventajan a (o se aprovechan de) otros gracias a la posesión de _información privilegiada_.
Esos vacíos de información en la persona desfavorecida son los que le impiden prosperar (competir, luchar) y revertir la situación.
¿Cuál es el motivo para _no compartir_ (más que _ocultar deliberadamente_) y enseñar los trucos y técnicas, para no explicar con espíritu docente las decisiones y los hechos consumados al resto de personas?
Me parece netamente inhumana la decisión consciente de no compartir el conocimiento o la información. No creo que sea justa, e intuyo que es la raíz de no pocas injusticias, tanto a nivel macro social, como en las distancias cortas, en el trato personal.
Supongo que esta visión deriva de mi incapacidad manifiesta para gestionar el remordimiento y la culpa tras el engaño, o el mero escamoteo de información en una negociación.
> Lo que termina por convertirme en bocachancla, como bien atestiguarán los que me conocen.

- Límites al entendimiento humano. Aunque la información está ahí y sea accesible, hemos descubierto recientemente una barrera que nos impide aprovecharla de manera práctica, pese a estar a nuestro alcance
> La barrera: nuestra propia incapacidad para digerirla.
¿Es la IA una esperanza para ello?

- La sociedad, la humanidad, el mundo, es un sistema caótico. Cualquier intento de conceptualizarlo/esquematizarlo desde cero, desde "arriba", termina por mostrarse estéril.
Por eso muchas teorías políticas fallan.
No se puede aspirar a una descripción sistemática, autocontenida, coherente, de la sociedad.
> Ahora añado "estática".
Solo a desentrañar las leyes naturales (físicas, psicológicas) que gobiernan las interacciones.
Es decir, no se puede deducir el comportamiento de una "clase" social, sino explicar la decisión que adoptan de manera matoritaria sus miembros, de acuerdo a parámetros psicológicos.
> Sus miembros como grupo estadístico _agregado_ de individuos, pero nunca uno por uno.
Se puede explicar por qué un asalariado o un empleador (no uso _trabajador_ y _empresario_ adrede. Ambos trabajan) toman ciertas decisiones; pero aspirar a un sistema estacionario de producción y consumo resulta, además de utópico, absurdo desde un punto de vista natural o matemático, ya que tal cosa _no puede_ existir, en el sentido más trascendente.
Para mí, la "conciencia de clase" es una categorización, etiquetado, contracción, reducción, condensación, demasiado simplista, porque "plancha" las diferencias individuales que finalmente son cause del cambio, y por tanto, de lo único explicable y categorizable.

20250904
pág. 123
El problema es que todas esas cosas son imposibles de medir. Posiblemente el azar sea la forma más justa existente
> o conocida
ya que al menos está libre de los prejuicios y sesgos que cualquier otra alternativa diseñada por unos humanos exhibiría inevitablemente.
- De hecho, las capacidades naturales son fruto del azar también. Con lo cuál, el "mérito", la "capacidad", la "valía", también son fruto de la suerte
> en última instancia.
Tan justo o injusto es recibir una herencia o nacer pobre, como ser inteligente o estúpido.
Autoproclamarse juez legítimo para dirimir lo justo de lo injusto sin extrema prudencia me parece poco menos que un delirio de grandeza, una visión deformada y aberrante de nuestras capacidades.
- El hecho de medir siempre distorsiona y condiciona (como en la cuántica). No se puede medir sin afectar al sistema objeto de la medición.
¿Combatir la especulación?
El sistema capitalista es justo en tanto que no pretende suplantar al azar, pero valora la capacidad de trabajo del individuo y su utilidad social.
Uno de sus fallos viene de la opacidad, de la toma de decisiones con información solo accesible para unos privilegiados.
Poder de negociación derivado de la acumulación. Especulación.Riesgo. Componente medioambiental.

El consumismo y el materialismo como "abstracción" de las relaciones humanas que garantiza la paz.

p124. Sin conciencia individual del coste de las cosas, se demuestra hoy en día (ahora que se han logrado ciertas conquistas básicas que sí eran esenciales y necesarias en el siglo XIX y XX) que hay derroche y mal uso. Abuso y egoísmo individual, aun a pequeña escala.
Por pura psicología, "el dinero público no es de nadie".
Anarquista hace 100 años, capitalista actualmente.
p125: Pregunta: ¿cuándo surgieron las drogas? ¿No constituye un fallo del sistema? ¿Por qué no gastarlo en drogas?

20250906
Realidad Orwelliana. Combatir el pensamiento único desde la prudencia, sin despotismo/paternalismo intelectual, sin creerse o onfiar en tener la verdad sobre otras personas.
Retórica, persuasión. Estudiar.

- El papel de la religión. ¿Por qué tanto ateísmo entre los pensadores del Siglo XIX, XX, ...?
- Desarrollo histórico como dialéctica de opuestos... ¿o como oscilador armónico?
Necesidad de encontrar un equilibrio conciliador entre posturas opuestas que nunca dejarán de serlo. 
Tambor como metáfora de la sociedad (de A.Huxley). Cada grupo debe tensar en su dirección, pero siendo consciente de que contribuye a una tensión óptima.
>global
Pilares o condiciones fundamentales para el progreso científico y artístico según B. Russell:
1. Formación técnica
2. Libertad para seguir el impulso creativo
3. Posibilidad de reconocimiento
Yo pregunto: ¿cuáles no se cumplen en el mundo occidental actual?

- Entender cómo se originan y manejan las "marcas"
